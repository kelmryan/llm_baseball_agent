...
class MistralAgent:
    ...
    def think_and_act(self, user_input):
        ...
        if any(phrase in input_lower for phrase in ['stats', 'batting', 'performance', 'how is', 'hitting']):
...
Please provide insightful commentary about this player's performance, noting strengths, areas for improvement, and how these numbers compare to typical MLB standards."""
        ...
        elif any(phrase in input_lower for phrase in ['defense', 'defensive lineup', 'field arrangement', 'starting lineup']):
